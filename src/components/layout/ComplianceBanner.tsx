...
export const ComplianceBanner: React.FC = () => {
  return (
    <div role="status" className="bg-[#eff4ff] border-b border-[#cbdbf5] text-[11px] text-[#213145] px-4 py-1.5 flex flex-col md:flex-row items-center justify-between gap-2 select-none">
      <div className="flex items-center gap-2 max-w-4xl">
        <ShieldCheck className="w-3.5 h-3.5 text-[#006398] shrink-0" aria-hidden="true" />
      ...
      <div className="flex items-center gap-3 shrink-0 font-mono text-[10px] text-[#45464d]">
        ...
        <span className="hidden sm:inline-flex items-center gap-1">
          <Lock className="w-2.5 h-2.5 text-[#45464d]" aria-hidden="true" />
